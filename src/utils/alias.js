...
export const GET_NAME_PATIENT = 'GET_NAME_PATIENT'
export const GET_GENDER_PATIENT = 'GET_GENDER_PATIENT'
export const GET_AGE_PATIENT = 'GET_AGE_PATIENT'
/**  
 * MUTATIONS TYPES AND ACTIONS' NAMES along namespace
*/
export const NAMESPACED_AUTH = 'auth'
export const NAMESPACED_PATIENT = 'patient'
