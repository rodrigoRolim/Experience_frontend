...
import ProcedimentList  from '../components/ProcedimentList'
...
export default {
  ...
  methods: {
    redirectToLogin () {
      this.$router.push({path: JSON.parse(localStorage.getItem('custom-access')).rootPath})
    }
  }
}
</script>
